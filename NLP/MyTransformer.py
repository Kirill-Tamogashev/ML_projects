...
class SelfAttention(nn.Module):
    ...
    def forward(self, values, keys, queries, mask):
        ...
        # queries shape: (N, query_length, heads, head_dim)
        # key shape: (N, key_length, heads, head_dim)
        ...
        # attention shape: (N, heads, query_length, key_length)
        # values shape: (N, value_len, self.heads, self.head_dim)
        # out shape: (N, query_length, self.heads, self.head_dim)
        # we flatten two last dimentions of `out`, so out shape: (N, query_length, self.heads * self.head_dim)
